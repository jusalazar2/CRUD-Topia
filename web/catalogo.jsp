...
<head>
    ...
    <title>Catálogo - Tu Tienda VV&M</title>
...
<body>
    <header>
        <h1>Tu Tienda V&M</h1>
             ...
             <a class="btn btn-outline-danger" href="login.jsp">Iniciar sesion</a>
                <img class ="logo" src="https://i.pinimg.com/200x150/e5/fd/04/e5fd043638ecf0185100dcae3ada1ec0.jpg" width="60" align='right'  height="60" right="60px" alt="Mi Logo">
...
<center>
    <section class="catalogo">
        ...
        <div class="producto">
            <img src="https://munimuni.com.co/cdn/shop/products/image_5ee4a7d2-3b8b-4e55-a08c-b4e130770119.jpg?v=1671470200" align='right'  alt="Producto 1">
            <h3>Peluches</h3>
            <p>Precio: $50.00</p>
            <a class="btn btn-outline-danger" href="carrito de compras.jsp">Ir a carrito</a>
        </div>
        <div class="producto">
